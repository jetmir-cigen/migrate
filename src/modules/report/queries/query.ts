...
export const groupByEmployeeNoGlobal = `
SELECT employee_no,
        amount,
        cse.salary_deduction_code_device AS accounting_code
FROM (
...
export const accountLocal = `SELECT co.code                        AS number
     , co.name
     , co.employee_no
     , co.accounting_code
     , d.name                         AS department_name
...
export const accountGlobal = `SELECT co.code                        AS number
     , co.name
     , co.employee_no
     , co.accounting_code
     , d.name                         AS department_name
...
export const offBoardingGlobal = `
    SELECT c.name      AS customer_name,
           co.name     AS user_name,
           co.code     AS user_number,
           co.employee_no,
...
export const consumptionGlobal = `
SELECT co.code
     , co.name
     , co.employee_no
     , co.benefit_mobile
...
export const salaryDeductionUsageLocal = `
 SELECT co.name
     , co.employee_no
...
export const salaryDeductionUsageGlobal = `
 SELECT co.name
     , co.employee_no
     , co.accounting_code as accounting_code_cost_object
     , co.benefit_mobile
...
export const taxAdvantageLocal = `
SELECT name
     , employee_no
...
export const taxAdvantageGlobal = `
SELECT name
     , employee_no
     , salary_deduction_amount + salary_deduction_amount_vat          AS salary_deduction_amount
     , content_service_amount
